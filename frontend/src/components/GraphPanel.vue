    ...
    <div class="graph-container" ref="graphContainer">
      ...
      <div v-if="graphData" class="graph-view">
        ...
        <div v-if="showSimulationFinishedHint" class="graph-building-hint finished-hint">
          ...
          <span class="hint-text">Some content is still processing. Try refreshing the graph later.</span>
...
const renderGraph = () => {
  ...
  const getLinkPath = (d) => {
    ...
    // Perpendicular offset from line direction, scaled by distance ratio for visible curves
    ...
    .call(d3.drag()
      ...
      .on('drag', (event, d) => {
        ...
        if (!d._isDragging && distance > 3) {
          // First actual drag detected, restart simulation
          d._isDragging = true
      ...
      .on('end', (event, d) => {
        // Only let simulation wind down if actual dragging occurred
        if (d._isDragging) {
