    ...
    interviewBlocks.forEach((block, index) => {
      ...
      if (answerMatch) {
        ...
        if (!twitterMatch && redditMatch) {
          // Only Reddit answer available, copy as default display if not placeholder
...
const renderMarkdown = (content) => {
  ...
  // Remove leading H2 title (## xxx) since section title is already displayed outside
...
const extractFinalContent = (response) => {
  ...
  // Try to find content after "Final Answer:" (alternative format)
