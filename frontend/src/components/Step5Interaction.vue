              ...
              <div class="tools-grid">
                ...
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Autonomous interviews that conduct parallel multi-turn conversations with individuals in the simulated world, collecting unstructured opinion data and psychological states</div>
                  </div>
                </div>
              </div>
            </div>
...
const sendToAgent = async (message) => {
  ...
  if (res.success && res.data) {
    ...
    if (typeof resultsDict === 'object' && !Array.isArray(resultsDict)) {
      // Prioritize reddit platform response, fallback to twitter
