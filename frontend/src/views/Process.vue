            ...
            <div class="phase-detail">
              <div class="detail-section">
                ...
                <div class="detail-content">
                  After uploading documents, the LLM analyzes document content and automatically generates an ontology structure (entity types + relation types) suited for opinion simulation.
                </div>
              </div>
