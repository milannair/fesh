"""
Report API routes
Provides interfaces for report generation, retrieval, and conversation
"""
...
def get_report_sections(report_id: str):
    ...
    The frontend can poll this API to get generated section content without waiting for the entire report
...
def get_agent_log(report_id: str):
    ...
    Retrieves each step in the report generation process in real-time, including:
...
def get_console_log(report_id: str):
    ...
    This differs from the agent-log API which returns structured JSON logs;
