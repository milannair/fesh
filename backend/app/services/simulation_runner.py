...
class SimulationRunner:
    ...
    def start_simulation(
        ...
        try:
            ...
            # Set working directory to the simulation directory (database files etc. will be generated here)
                        ...
                        try:
                            ...
                            if "event_type" in action_data:
                                ...
                                if event_type == "simulation_end":
                                    ...
                                    # If both platforms were run, both need to be completed
    ...
    def register_cleanup(cls):
        ...
        # In non-debug mode, this environment variable doesn't exist, so cleanup should still be registered
    ...
    def interview_agent(
        ...
        Args:
            ...
            platform: Specify platform (optional)
                ...
                - None: Interview on both platforms for dual-platform simulations, returning combined results
        ...
        if not ipc_client.check_env_alive():
            raise ValueError(f"Simulation environment is not running or has been shut down, cannot perform interview: {simulation_id}")
    ...
    def interview_agents_batch(
        ...
        Args:
            ...
            platform: Default platform (optional, overridden by each interview item's platform)
                - "twitter": Default to interviewing on the Twitter platform only
                - "reddit": Default to interviewing on the Reddit platform only
