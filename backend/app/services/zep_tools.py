...
class ZepToolsService:
    ...
    def get_all_edges(self, graph_id: str, include_temporal: bool = True) -> List[EdgeInfo]:
        """
        Get all edges of the graph (with pagination, including temporal info)
    ...
    def insight_forge(
        ...
        Most powerful hybrid retrieval function, auto-decomposes questions and performs multi-dimensional search:
        ...
        # Step 3: Extract related entity UUIDs from edges, only get info for those entities (not all nodes)
        entity_uuids = set()
...
- When quoting interviewee's original words, use quotation marks
