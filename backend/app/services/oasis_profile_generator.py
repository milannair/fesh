...
1. Calls Zep retrieval features to enrich node information
...
class OasisProfileGenerator:
    ...
    2. Generates highly detailed personas (including basic info, career, personality traits, social media behavior, etc.)
    3. Distinguishes between individual entities and abstract group entities
    """
    ...
    def __init__(
        ...
        # Zep client for retrieval-based context enrichment
    ...
    def _search_zep_for_entity(self, entity: EntityNode) -> Dict[str, Any]:
        """
        Use Zep graph hybrid search to get rich information about the entity

        Zep does not have a built-in hybrid search endpoint; edges and nodes need to be
    ...
    def _get_system_prompt(self, is_individual: bool) -> str:
        ...
        base_prompt = "You are a social media user persona generation expert. Generate detailed, realistic personas for public opinion simulation, maximally restoring existing real-world situations. You must return valid JSON format, and all string values must not contain unescaped newline characters. Use Chinese."
        return base_prompt
...
2. persona: Detailed persona description (2000 words of plain text), should include:
   ...
   - Stances and views (attitudes toward topics, content that may provoke or move them)
...
2. persona: Detailed account setting description (2000 words of plain text), should include:
   ...
   - Stances and attitudes (official stance on core topics, handling of controversies)
   - Special notes (represented group portrait, operational habits)
   - Institutional memory (important part of the persona, introduce this institution's connection to events, and its existing actions and reactions in events)
