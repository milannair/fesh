...
# Load the .env file from the project root directory (contains LLM_API_KEY and other configurations)
...
def disable_oasis_logging():
    ...
    OASIS logging is too verbose (logging each agent's observations and actions), we use our own action_logger
    """
...
def _enrich_action_context(
    ...
    try:
        ...
        # Create comment: supplement the commented post's information
...
async def main():
    ...
    # Create shutdown event at the start of the main function, ensuring the entire program can respond to exit signals
    ...
    if twitter_result and twitter_result.env:
        ...
        log_manager.info("[Twitter] Environment shut down")

    if reddit_result and reddit_result.env:
        await reddit_result.env.close()
        log_manager.info("[Reddit] Environment shut down")
